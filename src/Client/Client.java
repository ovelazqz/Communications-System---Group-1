...
public class Client {
    ...
    protected static Map<String, String> chatNameToID = new HashMap<>();
...
//            socket = new Socket("134.154.44.224", 5050); 
    ...
    public void sendCreateGroupChatRequest(String groupName, String[] selectedMembers) throws IOException {
        Map<String, Object> payload = new HashMap<>();
        payload.put("groupName", groupName);
        payload.put("recipients", selectedMembers);
    ...
    public void sendChatMessage(String chatID, String messageText) throws IOException {
        ...
        String chatIdentifier = chatNameToID.getOrDefault(chatID, chatID);
        
        Map<String, Object> payload = new HashMap<>();
        payload.put("chatID", chatIdentifier);
    ...
    public void requestUserList(ResponseHandler handler) throws IOException {
        new Thread(() -> {
            try {
                Map<String, Object> payload = new HashMap<>();
                Message msg = new Message("get_user_list", "get_users", payload);
                
                output.writeObject(msg);
                output.flush();
            } catch (IOException e) {
                System.out.println("Error sending user list request: " + e.getMessage());
            }
        }).start();
    }
    
    public static void storeChatID(String chatName, String chatID) {
        chatNameToID.put(chatName, chatID);
    }
